...
export default function ProductAnalytics({ stockBarData, categoryPieData, productsTimeLineData }) {
  ...
  const ExportButton = ({ chartRef, fileName }) => (
    <div className="relative opacity-0 group-hover:opacity-100 transition-all duration-300">
      <div className="group/export relative">
        ...
        <div className="absolute right-0 top-[calc(100%+8px)] w-48 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50 invisible group-hover/export:visible opacity-0 group-hover/export:opacity-100 transition-all duration-200">
          <button 
            onClick={() => exportChartPng(chartRef, fileName)}
          ...
          <button 
            onClick={() => exportChartPdf(chartRef, fileName)}
            className="w-full text-left px-4 py-2 text-sm font-bold text-gray-600 hover:bg-gray-50 flex items-center gap-2 transition-colors"
          >
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 lg:col-span-2 group">
        <div className="flex justify-between items-center mb-8">
          ...
          <ExportButton chartRef={barChartRef} fileName="stock_levels" />
        </div>
        <div className="h-80">
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 group">
        <div className="flex justify-between items-center mb-8">
          ...
          <ExportButton chartRef={pieChartRef} fileName="category_distribution" />
        </div>
        <div className="h-80">
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 group">
        <div className="flex justify-between items-center mb-8">
          ...
          <ExportButton chartRef={lineChartRef} fileName="inventory_growth" />
        </div>
        <div className="h-80">
